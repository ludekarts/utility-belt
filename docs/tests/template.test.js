...
describe("Dynamic Elements", () => {
  ...
  //   const renderListItem = item => dynamicElement(listItemUi, item);
  //   const list = repeater(renderListItem, items, item => item.id);

  //   chai.expect(list[1].textContent).to.be.equal("Item 2");
  ...
  //   const listItemUi = item => html`<li>${item.name}</li>`;
  //   const renderListItem = item => dynamicElement(listItemUi, item);
  //   const listA = repeater(renderListItem, items, item => item.id);

  //   const items2 = [...items];
  //   items[1].name = "Changed";

  //   const listB = repeater(renderListItem, items2, item => item.id);

  //   chai.expect(listA).not.to.be.equal(listB);
  //   chai.expect(listA[1]).to.be.equal(listB[1]);
  ...
  //   repeater(renderListItem, [], item => item.id);

  //   createRepeater.__setTerminateInterval(100);

  //   setTimeout(() => {
  //     items[1].name = "Changed";
  //     const listB = repeater(renderListItem, items, item => item.id);
  //     chai.expect(listA[1]).not.to.be.equal(listB[1]);
  //     createRepeater.__setTerminateInterval(300_000);
  //     done();
  //   }, 400);
  // });
